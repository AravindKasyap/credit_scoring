...
def main():
    ...
    input_data = {
        ...
        'PAY_0': st.number_input("PAY (repayment status in previous month; -1: paid in advance, 1: delay for one month, 2: delay for two months)", value=0.0),
        'PAY_2': st.number_input("PAY_2 (repayment status in last 2nd month; -1: paid in advance, 1: delay for one month, 2: delay for two months)", value=0.0),
